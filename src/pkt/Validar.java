...
public class Validar {
	...
	public static Categorias chkCategorias(String eCate) {
		...
		if (eCate.equals(Categorias.CATA.getDesc().toUpperCase().replace("Í", "I")) || letra == '1' || letra == 'A') {
			cat = Categorias.CATA;

		} else if (eCate.equals(Categorias.CATB.getDesc().toUpperCase().replace("Í", "I")) || letra == '2'
				|| letra == 'B') {
			cat = Categorias.CATB;

		} else if (eCate.equals(Categorias.CATC.getDesc().toUpperCase().replace("Í", "I")) || letra == '3'
				|| letra == 'C') {
			cat = Categorias.CATC;
